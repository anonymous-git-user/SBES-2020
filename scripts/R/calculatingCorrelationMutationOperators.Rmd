...
## Reading data
```{r}
evoResults1 <- read.csv('evoResults.csv', sep = ",", header = TRUE)
evoResults2 <- read.csv('evoResults2.csv', sep = ",", header = TRUE)
evoResults3 <- read.csv('evoResults3.csv', sep = ",", header = TRUE)

randoopResults1 <- read.csv('randoopResults.csv', sep = ",", header = TRUE)
randoopResults2 <- read.csv('randoopResults2.csv', sep = ",", header = TRUE)
randoopResults3 <- read.csv('randoopResults3.csv', sep = ",", header = TRUE)

manualResults1 <- read.csv('manualSuitesResults.csv', sep = ",", header = TRUE)
manualResults2 <- read.csv('manualSuitesResults2.csv', sep = ",", header = TRUE)
manualResults3 <- read.csv('manualSuitesResults3.csv', sep = ",", header = TRUE)
```
