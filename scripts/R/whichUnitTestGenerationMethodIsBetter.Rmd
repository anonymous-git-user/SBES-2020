...
## Reading data
```{r}
evoResults1 <- read.csv('evoResultsEvoAvg.csv', sep = ",", header = TRUE)
evoResults2 <- read.csv('evoResults2EvoAvg.csv', sep = ",", header = TRUE)
evoResults3 <- read.csv('evoResults3EvoAvg.csv', sep = ",", header = TRUE)

randoopResults1 <- read.csv('randoopResultsRandoopAvg.csv', sep = ",", header = TRUE)
randoopResults2 <- read.csv('randoopResults2RandoopAvg.csv', sep = ",", header = TRUE)
randoopResults3 <- read.csv('randoopResults3RandoopAvg.csv', sep = ",", header = TRUE)

manualResults1 <- read.csv('manualSuitesResultsPITAvg.csv', sep = ",", header = TRUE)
manualResults2 <- read.csv('manualSuitesResults2PITAvg.csv', sep = ",", header = TRUE)
manualResults3 <- read.csv('manualSuitesResults3PITAvg.csv', sep = ",", header = TRUE)
```
